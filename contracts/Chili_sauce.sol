 ...
 *
 *                              NFT Contract
 * Author: Thanabhorn_Jantharat_Nattaporn
 * SutdentID: 62070505206_62070505216_62070505219
 * ContractName: Chili_sauce
 *
 **********************************************************************************
 */
...
contract Chili_sauce is ERC721A {
    ...
    modifier onlyOwner() {
        require(owner == msg.sender, "Chili_sauce: not owner");
        _;
    }
     ...
     */
    constructor() ERC721A("Chili_sauce NFT", "Chili") {
        owner = msg.sender;
    }
